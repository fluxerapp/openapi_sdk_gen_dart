...
mixin _$AgentConfig {
 ...
 String? get description; String? get mode; AgentConfigPermission? get permission;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,model,temperature,topP,prompt,const DeepCollectionEquality().hash(tools),disable,description,mode,permission);
...
@useResult
$Res call({
 String? model, num? temperature,@JsonKey(name: 'top_p') num? topP, String? prompt, Map<String, bool>? tools, bool? disable, String? description, String? mode, AgentConfigPermission? permission
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? model,  num? temperature, @JsonKey(name: 'top_p')  num? topP,  String? prompt,  Map<String, bool>? tools,  bool? disable,  String? description,  String? mode,  AgentConfigPermission? permission)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AgentConfig() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? model,  num? temperature, @JsonKey(name: 'top_p')  num? topP,  String? prompt,  Map<String, bool>? tools,  bool? disable,  String? description,  String? mode,  AgentConfigPermission? permission)  $default,) {final _that = this;
switch (_that) {
case _AgentConfig():
return $default(_that.model,_that.temperature,_that.topP,_that.prompt,_that.tools,_that.disable,_that.description,_that.mode,_that.permission);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? model,  num? temperature, @JsonKey(name: 'top_p')  num? topP,  String? prompt,  Map<String, bool>? tools,  bool? disable,  String? description,  String? mode,  AgentConfigPermission? permission)?  $default,) {final _that = this;
switch (_that) {
case _AgentConfig() when $default != null:
return $default(_that.model,_that.temperature,_that.topP,_that.prompt,_that.tools,_that.disable,_that.description,_that.mode,_that.permission);case _:
  return null;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,model,temperature,topP,prompt,const DeepCollectionEquality().hash(_tools),disable,description,mode,permission);
